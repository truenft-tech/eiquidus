...
exports.webserver = {
  ...
  "tls": {
    ...
    "cert_file": "/etc/letsencrypt/live/explorer.truenft.tech/cert.pem",
    ...
    "chain_file": "/etc/letsencrypt/live/explorer.truenft.tech/chain.pem",
    ...
    "key_file": "/etc/letsencrypt/live/explorer.truenft.tech/privkey.pem"
  },
...
exports.api_page = {
  ...
  "sample_data": {
    // namespace:  This value can be any valid namespace
    //             NOTE: This value is only used to build example api links on the api page from the /api/tnft_get api for example
    "namespace_id": "TDxrcNDxJ7TG3SLVp7UBeTzYEXXWZEMKdT",
    // key:        This value can be any valid key in a valid namespace
    //             NOTE: This value is only used to build example api links on the api page from the /api/tnft_get api for example
    "key": "3049",
  ...
  "public_apis": {
    ...
    "rpc": {
      // tnft_get: a collection of settings that pertain to the /api/tnft_get api endpoint
      //                Returns the value of the key in the namespace
...
exports.api_cmds = {
  ...
  "use_rpc": true,
  // tnft_get: Returns the value of the key at the given namespace
  "tnft_get": "tnft_get",
